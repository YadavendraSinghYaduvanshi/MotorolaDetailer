...
public class CinemaGraphFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_cinema_graph, container, false);
        decalartion(view);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_high_resolution:
             ...
             //  Glide.with(this).load(R.raw.sword).into(relative_layout_view);
