...
public class RAMVideoFragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view  = inflater.inflate(R.layout.fragment_ramvideo, container, false);
        decalartion(view);
        return view;
    }
    ...
    private void decalartion(View view) {
        ...
        String path = CommonString.VIDEO_PATH + "media.mp4";
